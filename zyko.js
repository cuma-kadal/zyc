...
if (!img) return img;
zyko.sendMessage(m.chat, { image: { url: img }, caption: '© Nih cecanukhty, jangan lupa subscribe channel ZYKO MD OFFICIAL 👍' }, { quoted: m });
}
break
case 'exo': {
...
let img = bpink[Math.floor(Math.random() * bpink.length)];
if (!img) return img;
zyko.sendMessage(m.chat, { image: { url: img }, caption: '© Nih exo, jangan lupa subscribe channel ZYKO MD OFFICIAL 👍' }, { quoted: m });
}
break
case 'blackpink': {
...
let img = bpink[Math.floor(Math.random() * bpink.length)];
if (!img) return img;
zyko.sendMessage(m.chat, { image: { url: img }, caption: '© Nih Blackpinknya, jangan lupa subscribe channel ZYKO MD OFFICIAL 👍' }, { quoted: m });
}
break;
case 'bts': {
...
if (!img) return img;
zyko.sendMessage(m.chat, { image: { url: img }, caption: '© Nih bts, jangan lupa subscribe channel ZYKO MD OFFICIAL 👍' }, { quoted: m });
}
break;
case 'cecanrandom': {
...
if (!img) return img;
zyko.sendMessage(m.chat, { image: { url: img }, caption: '© Nih cecanrandom, jangan lupa subscribe channel ZYKO MD OFFICIAL 👍' }, { quoted: m });
}
break;
//Menu Asupan
case 'filebokep':  {
